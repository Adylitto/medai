import React, { useState } from 'react';
    ...
    const translations = {
      ...
      fr: {
        header: "MedAI Collective",
        subheader: "Solutions décentralisées pour les professionnels de la santé",
        overviewTitle: "Aperçu du Projet",
        overviewText: "MedAI Collective est une application d'IA décentralisée conçue pour aider les professionnels de la santé à gérer efficacement les tâches administratives tout en garantissant la sécurité des données.",
        ...
        useCasesText: "Découvrez comment MedAI Collective peut transformer votre pratique :",
        useCases: [
          "Simplifiez la documentation des patients avec une transcription vocale précise.",
          "Gérez les dossiers patients en toute sécurité grâce à des solutions de stockage décentralisées.",
          "Participez à la gouvernance de la plateforme via notre structure DAO."
        ],
        testimonialsTitle: "Témoignages de Médecins",
        testimonials: [
          { text: "MedAI Collective a révolutionné ma gestion des tâches administratives. C'est un véritable atout !", author: "Dr. Émilie Dupont" },
          { text: "L'approche décentralisée garantit la sécurité et la conformité des données de mes patients.", author: "Dr. Michel Martin" }
        ],
        ctaTitle: "Rejoignez-nous",
        ctaText: "Faites partie de l'avenir de l'administration médicale. Rejoignez MedAI Collective dès aujourd'hui !",
        ctaButton: "Commencer",
